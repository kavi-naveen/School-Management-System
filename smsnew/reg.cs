...
namespace smsnew
{
    public partial class reg : Form
    {
        ...
        {
            String query = "SELECT * FROM student WHERE CONCAT (Student_id,Name) like '%" + valueToSearch + "%'";
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            if (nm.Text != "" && si.Text != "" && add.Text != "")
            {
                try
                {
                    ...
                    string Query = "insert into school.student(Student_id,Name,Phone,Dob,Gender,Address) values('"+this.si.Text+"','" + this.nm.Text + "','" + this.pn.Text + "','" + this.dob1.Value.ToString("yyyy.MM.dd") + "','" + this.gen.Text + "','" + this.add.Text + "');";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update school.student set Student_id='" + this.si.Text + "',name='" + this.nm.Text + "',Phone='" + this.pn.Text + "',Dob='" + this.dob1.Value.ToString("yyyy.MM.dd") + "',Gender='" + this.gen.Text + "',Address='" + this.add.Text + "' where Student_id='" + this.si.Text + "';";
                //This is  MySqlConnection here i have created the object and pass my connection string.
                MySqlConnection MyConn2 = new MySqlConnection(MyConnection2);
                MySqlCommand MyCommand2 = new MySqlCommand(Query, MyConn2);
                MySqlDataReader MyReader2;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string deleteQuery = "DELETE FROM `student` WHERE `student`.`Student_id` = " + Int32.Parse(si.Text);
