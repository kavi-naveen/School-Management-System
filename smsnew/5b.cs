...
namespace smsnew
{
    public partial class _5b : Form
    {
        ...
        public void populateDGV()
        {
            ...
            string selectQuery = "SELECT * FROM 5b";
        ...
        {
            String query = "SELECT * FROM 5b WHERE CONCAT (Student_id,Name) like '%" + valueToSearch + "%'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (a.Text != "" && st.Text != "" && b.Text != "")
            {
                try
                {
                    ...
                    string Query = "insert into school.5b(Student_id,Name,Sinhala,English,Mathematics,Environment,Realign,Total,Average) values('"+this.st.Text+"','"+this.nm.Text+"','" + this.a.Text + "','" + this.b.Text + "','" + this.c.Text + "','" + this.d.Text + "','" + this.h.Text + "','" + this.lb1.Text + "','" + this.lb2.Text + "');";
        ...
        private void show()
        {
            ...
            MySqlDataAdapter adapter = new MySqlDataAdapter("select * from 5b", con);
        ...
        private void _5b_Load(object sender, EventArgs e)
        {
            show();
            populateDGV();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                string deleteQuery = "DELETE FROM `5b` WHERE `5b`.`Student_id` = " + Int32.Parse(st.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update school.5b set Student_id='" + this.st.Text + "',Name='"+this.nm.Text+"',Sinhala='" + this.a.Text + "',English='" + this.b.Text + "',Mathematics='" + this.c.Text + "',Environment='" + this.d.Text + "',Realign='" + this.h.Text + "',Total='" + this.lb1.Text + "',Average='" + this.lb2.Text + "'  where Student_id='" + this.st.Text + "';";
                //This is  MySqlConnection here i have created the object and pass my connection string.
                MySqlConnection MyConn2 = new MySqlConnection(MyConnection2);
                MySqlCommand MyCommand2 = new MySqlCommand(Query, MyConn2);
                MySqlDataReader MyReader2;
